    ...
    const deleteAllBookings = async () => {
        ...
        try {
            ...
            if (err.response?.data?.activeCount) {
                ...
                setForceDelete(true);
                // Don't close the modal, let user confirm with force delete
            } else {
                ...
                <div className="mybookings-container">
                    ...
                    {filteredBookings.length === 0 ? (
                        <div className="empty-state">
                            ...
                            <button className="browse-button" onClick={() => navigate('/spaces')}>
                                🏠 Browse Spaces
                            </button>
                        </div>
                    ) : (
                        <div className="bookings-list">
                            {filteredBookings.map((booking) => {
                                ...
                                const unitImage = booking.unit?.images?.[0] ||
                                    (booking.unit?.unit_type === 'open_desk'
                                        ? 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&h=300&fit=crop'
                                        : 'https://images.unsplash.com/photo-1497366754035-f2001d9f5d8c?w=400&h=300&fit=crop');
                                ...
                                return (
                                    ...
                                    >
                                        <div className="booking-image">
                                            <img src={unitImage} alt={booking.unit?.name} />
